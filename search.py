...
class Indexable(object):
    ...
    def __repr__(self):
        # some vague things here. keys() is for select results from searching to show outside
        return ' '.join(self.words_count.keys())
...
class SearchEngine(object):
    ...
    def search(self, query, n_results=10):
        ...
        for doc_index in docs_indices:
            ...
            #result = IndexableResult(doc_score, indexable).score
